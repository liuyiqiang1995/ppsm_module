...
import com.ppsm.mobile.sys.base.context.NaomsSystemContext;
import com.ppsm.mobile.sys.base.exception.PpsmException;
 ...
 * @Description:
 * @Author: LiuYiQiang
 * @Date: 22:07 2018/5/10
 */
@Component
public class ServiceInvokeAop {

    private static Logger logger = LoggerFactory.getLogger(ServiceInvokeAop.class);
    ...
    public void doAfterThrow(JoinPoint jp, Throwable ex) throws Throwable {
        logger.error(getLogMessage(jp), ex);
        if (ex instanceof PpsmException) {
